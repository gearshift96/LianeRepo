...
// Cross Module References
	...
	LIANEGAME_API UFunction* Z_Construct_UFunction_ALianeGameCharacter_MoveActor();
...
// End Cross Module References
	void ALianeGameCharacter::StaticRegisterNativesALianeGameCharacter()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "MoveActor", &ALianeGameCharacter::execMoveActor },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	UFunction* Z_Construct_UFunction_ALianeGameCharacter_MoveActor()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				...
				{ "ToolTip", "Called to move a grabbed object back/forward" },
			};
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_ALianeGameCharacter, "MoveActor", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00040401, 0, nullptr, 0, 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
	...
	UClass* Z_Construct_UClass_ALianeGameCharacter()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_ALianeGameCharacter_MoveActor, "MoveActor" }, // 3616483142
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_ThrowStrength = { UE4CodeGen_Private::EPropertyClass::Float, "ThrowStrength", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(ALianeGameCharacter, ThrowStrength), METADATA_PARAMS(NewProp_ThrowStrength_MetaData, ARRAY_COUNT(NewProp_ThrowStrength_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_PullDirection = { UE4CodeGen_Private::EPropertyClass::Float, "PullDirection", RF_Public|RF_Transient|RF_MarkAsNative, 0x0040000000000001, 1, nullptr, STRUCT_OFFSET(ALianeGameCharacter, PullDirection), METADATA_PARAMS(NewProp_PullDirection_MetaData, ARRAY_COUNT(NewProp_PullDirection_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TKCamera_MetaData[] = {
				{ "AllowPrivateAccess", "true" },
				{ "Category", "Camera" },
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "LianeGameCharacter.h" },
				{ "ToolTip", "Telekinesis camera" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_TKCamera = { UE4CodeGen_Private::EPropertyClass::Object, "TKCamera", RF_Public|RF_Transient|RF_MarkAsNative, 0x00400000000a001d, 1, nullptr, STRUCT_OFFSET(ALianeGameCharacter, TKCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(NewProp_TKCamera_MetaData, ARRAY_COUNT(NewProp_TKCamera_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_FollowCamera = { UE4CodeGen_Private::EPropertyClass::Object, "FollowCamera", RF_Public|RF_Transient|RF_MarkAsNative, 0x00400000000a001d, 1, nullptr, STRUCT_OFFSET(ALianeGameCharacter, FollowCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(NewProp_FollowCamera_MetaData, ARRAY_COUNT(NewProp_FollowCamera_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_CameraBoom = { UE4CodeGen_Private::EPropertyClass::Object, "CameraBoom", RF_Public|RF_Transient|RF_MarkAsNative, 0x00400000000a001d, 1, nullptr, STRUCT_OFFSET(ALianeGameCharacter, CameraBoom), Z_Construct_UClass_USpringArmComponent_NoRegister, METADATA_PARAMS(NewProp_CameraBoom_MetaData, ARRAY_COUNT(NewProp_CameraBoom_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_TKCamera,
	...
	IMPLEMENT_CLASS(ALianeGameCharacter, 493338237);
