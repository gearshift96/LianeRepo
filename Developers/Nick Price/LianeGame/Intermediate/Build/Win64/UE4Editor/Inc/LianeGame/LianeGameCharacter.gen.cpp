...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ALianeGameCharacter()
	{
		...
		if (!OuterClass)
		{
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bIsInTK_MetaData[] = {
				{ "Category", "Telekinesis" },
				{ "ModuleRelativePath", "LianeGameCharacter.h" },
				{ "ToolTip", "The strength of the telekinesis throw" },
			};
#endif
			auto NewProp_bIsInTK_SetBit = [](void* Obj){ ((ALianeGameCharacter*)Obj)->bIsInTK = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsInTK = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsInTK", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(ALianeGameCharacter), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsInTK_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsInTK_MetaData, ARRAY_COUNT(NewProp_bIsInTK_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TK_Height_MetaData[] = {
				{ "Category", "Telekinesis" },
				{ "ModuleRelativePath", "LianeGameCharacter.h" },
				{ "ToolTip", "The height of the grabbed object from the ground in cm" },
			};
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_TK_Height = { UE4CodeGen_Private::EPropertyClass::Float, "TK_Height", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(ALianeGameCharacter, TK_Height), METADATA_PARAMS(NewProp_TK_Height_MetaData, ARRAY_COUNT(NewProp_TK_Height_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bIsInTK,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ThrowStrength,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_TK_Height,
	...
	IMPLEMENT_CLASS(ALianeGameCharacter, 3416213146);
